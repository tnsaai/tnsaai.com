    ...
    <div className="bg-white min-h-screen" style={{ paddingTop: '150px' }}>
      <div className="mx-auto max-w-3xl px-6">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-normal text-black" style={{ marginTop: '0px', marginBottom: '48px' }}>NGen 3 140M Instruct</h1>
        </div>

        <div className="relative w-full max-w-[860px] mx-auto mb-12 aspect-[1028/560]">
          <Image
            src="/model-images/ngen3-140mit.png"
        ...
        <div className="mx-auto max-w-3xl px-6">
          <div className="mb-12">
            ...
            <p className="text-sm text-gray-700 leading-relaxed">
              NGen 3 140M Instruct is an instruction-tuned model optimized for following specific tasks and commands with high accuracy and efficiency.
            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <ul className="list-disc list-inside text-sm text-gray-700 leading-relaxed space-y-2">
              <li>Instruction-tuned for task-focused applications</li>
              <li>High accuracy in following commands</li>
              <li>Compact 140M parameter model</li>
              <li>Optimized for specific task execution</li>
            </ul>
          </div>
