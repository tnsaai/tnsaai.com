...
export default function NGen4OW4BThinkingPage() {
    return (
        <NGen4OWModelPage
            title="NGen-4-OW-4B-Thinking"
            imageSrc="https://raw.githubusercontent.com/tnsaai/images-urls/refs/heads/main/ngen4ow4b.png"
            imageAlt="NGen-4-OW-4B-Thinking"
            huggingFaceUrl="https://huggingface.co/TNSA/NGen-4-OW-4B-Thinking"
            releaseNoteParagraphs={[
                'This model is a fine-tuned derivative of the NGen-4 Pro model. We have distilled deep Indic Knowledge into the Qwen 3.5 4B Base model.',
