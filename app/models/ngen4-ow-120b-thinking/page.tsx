...
export default function NGen4OW120BThinkingPage() {
    return (
        <NGen4OWModelPage
            title="NGen-4-OW-120B-Thinking"
            imageSrc="https://raw.githubusercontent.com/tnsaai/images-urls/refs/heads/main/ngen4ow120b.png"
            imageAlt="NGen-4-OW-120B-Thinking"
            huggingFaceUrl="https://huggingface.co/TNSA/NGen-4-OW-120B-Thinking"
