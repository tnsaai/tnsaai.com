    ...
    <div className="bg-white min-h-screen" style={{ paddingTop: '150px' }}>
      <div className="mx-auto max-w-3xl px-6">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-normal text-black" style={{ marginTop: '0px', marginBottom: '48px' }}>Stellar Large</h1>
        </div>
        ...
        <div className="mx-auto max-w-3xl px-6">
          <div className="mb-12">
            ...
            <p className="text-sm text-gray-700 leading-relaxed">
              Stellar Large is an enterprise-ready reasoning model at stellar scale, designed for complex problem-solving and advanced analytical tasks.
            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <ul className="list-disc list-inside text-sm text-gray-700 leading-relaxed space-y-2">
              <li>Stellar scale reasoning capabilities</li>
              <li>Enterprise-ready performance</li>
