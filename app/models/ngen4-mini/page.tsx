        ...
        <div className="bg-white min-h-screen" style={{ paddingTop: '186px' }}>
            ...
            <div className="bg-white">
                <div className="mx-auto max-w-4xl px-6">
                    ...
                    <div className="mb-16">
                        <h2 className="mb-6 text-2xl text-gray-900">NGen 4 Mini Highlights.</h2>
                        <div className="grid grid-cols-1 gap-x-12 gap-y-8 md:grid-cols-2">
                            <div>
                                <h3 className="mb-2 text-lg font-medium text-black">Unified Vision-Language Foundation</h3>
                            ...
                            <div>
                                <h3 className="mb-2 text-lg font-medium text-black">Efficient Hybrid Architecture</h3>
                            ...
                            <div>
                                <h3 className="mb-2 text-lg font-medium text-black">Thinking Mode Enabled</h3>
                            ...
                            <div>
                                <h3 className="mb-2 text-lg font-medium text-black">Global Accessibility</h3>
                    ...
                    <div className="mb-16">
                        <h2 className="mb-4 text-2xl text-gray-900">Context & Specs.</h2>
                    ...
                    <div className="mb-16">
                        <h2 className="mb-4 text-2xl text-gray-900">Key Capabilities.</h2>
                    ...
                    <div className="mb-16">
                        <h2 className="mb-4 text-2xl text-gray-900">Pricing.</h2>
                        <p className="text-base leading-relaxed text-gray-700">$2.00 per 1M tokens</p>
                    </div>

                    <div className="mb-16">
                        <h2 className="mb-4 text-2xl text-gray-900">Serving & Best Practices.</h2>
                        <div className="space-y-6 text-base leading-relaxed text-gray-700">
                            ...
                            <div>
                                <h3 className="mb-2 text-lg font-medium text-black">Adequate Output Length</h3>
