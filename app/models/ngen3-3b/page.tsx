    ...
    <div className="bg-white min-h-screen" style={{ paddingTop: '150px' }}>
      <div className="mx-auto max-w-3xl px-6">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-normal text-black" style={{ marginTop: '0px', marginBottom: '48px' }}>NGen 3 3B</h1>
        </div>

        <div className="relative w-full max-w-[860px] mx-auto mb-12 aspect-[1028/560]">
          <Image
            src="/model-images/ngen3-3b.png"
            alt="NGen 3 3B"
            fill
            priority
        ...
        <div className="mx-auto max-w-3xl px-6">
          <div className="mb-12">
            ...
            <p className="text-sm text-gray-700 leading-relaxed">
              NGen 3 3B provides accessible AI with 3 billion parameters, delivering efficient performance for a wide range of applications at an affordable price point.
            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <ul className="list-disc list-inside text-sm text-gray-700 leading-relaxed space-y-2">
              <li>3 billion parameter accessible model</li>
              <li>Cost-effective AI solution</li>
